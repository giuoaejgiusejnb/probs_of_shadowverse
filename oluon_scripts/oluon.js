import { ProbsOfRandomDamagesHit } from "../javascript_scripts/probs_of_random_damages_hit.js";
...
decideButton.addEventListener('click', () => {
    ...
    // 確率を表示する
    el1.textContent = "自分リーダーがリーサルを取られる確率：" + (results[0]*100).toPrecision(10) + "%";
    el2.textContent = "相手リーダーがリーサルを取られる確率：" + (results[1]*100).toPrecision(10) + "%";
});